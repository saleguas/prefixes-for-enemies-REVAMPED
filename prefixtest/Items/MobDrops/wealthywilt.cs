...
{
    public class wealthywilt : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wealthy Wilt"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            Tooltip.SetDefault("Mow your enemies down.");
        }
