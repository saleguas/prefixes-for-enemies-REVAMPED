...
{
    public class dwellerdelight : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Dweller's Delight"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            Tooltip.SetDefault("Shoots a storm of copper and silver coins.");
        }
