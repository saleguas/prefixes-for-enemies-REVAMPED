...
namespace prefixtest.Items.Tokens.tier1 {
  public class hybridblade1: ModItem {
    public override void SetStaticDefaults() {
      DisplayName.SetDefault("HybridBlade"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
