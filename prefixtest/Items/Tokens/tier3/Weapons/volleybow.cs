...
namespace prefixtest.Items.Tokens.tier3.Weapons
{
    public class volleybow : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Volley Bow"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        ...
        public override void SetDefaults()
        {
            ...
            // Use Properties
            Item.useTime = 70; // The item's use time in ticks (60 ticks == 1 second.)
