...
namespace prefixtest.Items
{
	public class BasicSword2 : ModItem
	{
		...
		{
			DisplayName.SetDefault("Ghastly Charm");
			// DisplayName.SetDefault("BasicSword2"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
			Tooltip.SetDefault("Grants temporary extra invincibility frames on hit, but at what cost?");
		}
