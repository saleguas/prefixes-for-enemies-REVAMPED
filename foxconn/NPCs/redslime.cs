...
namespace foxconn.NPCs
{
    ...
    public class redslime : ModNPC
    {
        ...
        {
            return SpawnCondition.OverworldDaySlime.Chance * 0.2f; // Spawn with 1/5th the chance of a regular BlueSlime.
        }
        ...
        {
            // add confused, slow, weak, poison, cursed, fire, frostburn, and shadowflame debuffs
            // add ichor, venom, cursed,
            // add blind
