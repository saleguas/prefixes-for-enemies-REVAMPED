...
namespace luckyblocks.Items.Tokens.tier1.Weapons
{
    public class omnirang : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip
                .SetDefault("Good luck catching all of them\n Shoots 8 boomerangs.");
        }
        ...
        )
        {
            ...
            Projectile
                .NewProjectile(source,
                position,
                new Vector2(vel.X + 10f, vel.Y + 10f),
                type,
                damage,
                knockback,
                player.whoAmI);
