...
namespace prefixtest.Items.Ammo
{
	// This Example class demonstrates how to make your own weapon ammo.
	// Used by ExampleCustomAmmoGun
	public class slug : ModItem
	{
		public override void SetStaticDefaults() {
      DisplayName.SetDefault("Slug"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.

			Tooltip.SetDefault("Shoots an exploding cannonball."); // The item's description, can be set to whatever you want.
		}
		...
		public override void SetDefaults() {
			...
			Item.shoot = 162; // The projectile that weapons fire when using this item as ammunition.
