...
namespace prefixtest.Items.MobDrops {
  public class peddlersplea: ModItem {
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
      ...
      Vector2 velocity2 = new Vector2(velocity.X + Main.rand.NextFloat(-5f, 5f), velocity.Y + Main.rand.NextFloat(-5f, 5f));
      int a = Projectile.NewProjectile(source, position, velocity2, type, damage, knockback, player.whoAmI);
