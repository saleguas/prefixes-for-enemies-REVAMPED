...
namespace prefixtest.Projectiles
{
    ...
    public override void AI() {
      ...
      for (int i = 0; i < NumProjectiles; i++) {
        ...
        //Create a projectile.
        Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.position, newVelocity, type, Projectile.damage , 5, Projectile.owner); // 13 damage 5 knockback
      }
