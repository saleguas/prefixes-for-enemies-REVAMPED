...
{
	public class runeblast : ModItem
	{
		public override void SetStaticDefaults() {
      DisplayName.SetDefault("Rune blast"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
		...
		public override void SetDefaults() {
			...
			// Gun Properties
			Item.shoot = 129; // For some reason, all the guns in the vanilla source have this.
