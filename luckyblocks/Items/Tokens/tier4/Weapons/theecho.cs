	...
	public class theecho : ModItem
	{
      ...
      DisplayName.SetDefault("The Echo"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
		...
		public override void SetDefaults() {
			...
			// Gun Properties
			Item.shoot = ModContent.ProjectileType<Projectiles.theechoproj>(); // For some reason, all the guns in the vanilla source have this.
			Item.shootSpeed = 25f; // The speed of the projectile (measureed in pixels per frame.)
		}
