...
namespace prefixtest
{
	public class soulShardCurrencyData : CustomCurrencySingleCoin
	{
		...
		public soulShardCurrencyData(int coinItemID, long currencyCap) : base(coinItemID, currencyCap) {
		}
  ...
  public class soulCurrencyData : CustomCurrencySingleCoin
  {
    ...
    public soulCurrencyData(int coinItemID, long currencyCap) : base(coinItemID, currencyCap) {
    }
