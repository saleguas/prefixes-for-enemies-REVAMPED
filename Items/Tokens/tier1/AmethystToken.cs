		...
		public override bool? UseItem(Player player)
{
		...
		switch (x)
		{
				...
				case 7:
						...
						new CommonDrop(ModContent.ItemType<volleybow>(), 1, 1, 1, 1);
						break;
				case 8:
