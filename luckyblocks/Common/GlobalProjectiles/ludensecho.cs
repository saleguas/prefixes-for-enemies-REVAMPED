...
namespace luckyblocks.Common.GlobalProjectiles
{
    // Here is a class dedicated to showcasing projectile modifications
    public class ludensecho : GlobalProjectile
    {
        public override bool
        AppliesToEntity(Projectile projectile, bool lateInstatiation)
        {
            return projectile.type ==
            ModContent.ProjectileType<Projectiles.theechoproj>();
        }
